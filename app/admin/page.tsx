    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-green-500">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">🎬 Full Dashboard</h2>
          <p className="text-gray-600 mb-4">Videos, Products, Carousel, Gallery - All Features</p>
          <Link href="/admin/dashboard" className="text-green-600 hover:text-green-800 font-bold">
            Open Dashboard →
          </Link>
        </div>
