...
const NAV = [
  ...
  { to: '/gate-vkd-control-2026/certifications-gallery', end: false, label: 'Giấy Chứng Nhận', icon: ShieldCheck },
  ...
  { to: '/gate-vkd-control-2026/product-menu', end: false, label: 'Menu Sản Phẩm', icon: Package },
  { to: '/gate-vkd-control-2026/blog-categories', end: false, label: 'Danh Mục Blog', icon: FileText },
  { to: '/gate-vkd-control-2026/policy-content', end: false, label: 'Trang Chính Sách', icon: FileText },
  { to: '/gate-vkd-control-2026/site-config', end: false, label: 'Cài Đặt Trang', icon: Settings },
