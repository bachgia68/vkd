...
export const vkdProducts: VKDProduct[] = [
  ...
  // --- Trà & Rượu Sâm ---
  {
    ...
    description: 'Dòng rượu Ngọc Đế cao cấp, ngâm ủ truyền thống cùng Sâm Ngọc Linh — sản phẩm của TA.',
    volume: '750ml',
  ...
  },
  {
    ...
    description: 'Rượu Ngọc Đế dòng Thăng Long, chai cao — sản phẩm của TA.',
    volume: '500ml',
