...
export const translations: Record<Language, Translation> = {
  vi: {
    ...
    hero: {
      badge: 'Sàn Giao Dịch Sâm Ngọc Linh Uy Tín',
      titleLine1: 'Kho Báu Triệu Năm',
      titleLine2: 'Từ Rừng Sâu Việt Nam',
      subtitle: 'TA — Sàn giao dịch Sâm Ngọc Linh minh bạch, kết nối trực tiếp các vùng trồng chuẩn GACP-WHO lớn nhất Việt Nam. Mọi sản phẩm đều được thẩm định độc lập, chứng nhận cGMP, HACCP, ISO 9001/22000 và truy xuất nguồn gốc rõ ràng.',
      cta: 'Khám Phá Ngay',
    ...
    about: {
      ...
      title: 'Về Chúng Tôi',
      titleHighlight: '',
      description1: 'TA là sàn giao dịch Sâm Ngọc Linh (Panax vietnamensis) uy tín, kết nối người tiêu dùng với các vùng trồng đạt chuẩn và nhà cung ứng đã qua thẩm định — không giới hạn ở một thương hiệu duy nhất.',
      description2: 'Mỗi đối tác cung ứng trên TA đều trải qua quy trình thẩm định độc lập về vùng trồng chuẩn GACP-WHO, hồ sơ kiểm nghiệm và truy xuất nguồn gốc, với sự tư vấn từ đội ngũ chuyên gia dược liệu hàng đầu.',
      description3: 'Hệ sinh thái sản phẩm đa dạng từ thực phẩm bổ sung, nước tăng lực, đến mỹ phẩm cao cấp — tất cả đều minh bạch nguồn gốc và đạt tiêu chuẩn quốc tế trước khi có mặt trên sàn.',
      cta: 'Tìm Hiểu Thêm',
    ...
    footer: {
      ...
      contact: 'Liên Hệ',
      followUs: 'Theo Dõi',
      address: '55 Ngọc Hà Village, Ba Đình, Hà Nội, Việt Nam',
      phone: 'Zalo / WhatsApp: (84) 984 999 309',
      email: 'lienhe@samngoclinh-ta.vn',
  ...
  en: {
    ...
    hero: {
      badge: 'The Trusted Ngoc Linh Ginseng Marketplace',
      titleLine1: 'The Billion-Year Treasure',
      titleLine2: "of Vietnam's Deep Forest",
      subtitle: 'TA is a transparent trading marketplace for Ngoc Linh Ginseng, connecting directly to the largest GACP-WHO certified cultivation regions in Vietnam. Every product is independently verified, certified cGMP, HACCP, ISO 9001/22000, and fully traceable.',
      cta: 'Discover Now',
    ...
    about: {
      ...
      title: 'About Us',
      titleHighlight: '',
      description1: 'TA is a trusted trading marketplace for Ngoc Linh Ginseng (Panax vietnamensis), connecting consumers with vetted cultivation regions and suppliers — not tied to a single brand.',
      description2: 'Every supplier on TA is independently vetted for GACP-WHO certified cultivation, lab testing records, and full traceability, backed by advisory from leading herbal medicine experts.',
      description3: 'A diverse product ecosystem from supplements, energy drinks, to premium cosmetics — every listing is traceable and meets international standards before it reaches the marketplace.',
      cta: 'Learn More',
      region1Name: 'Tu Mơ Rông, Kon Tum',
    ...
    footer: {
      ...
      contact: 'Contact',
      followUs: 'Follow Us',
      address: '55 Ngoc Ha Village, Ba Dinh, Hanoi, Vietnam',
      phone: 'Zalo / WhatsApp: (84) 984 999 309',
      email: 'contact@samngoclinh-ta.vn',
  ...
  zh: {
    ...
    hero: {
      ...
      titleLine1: '亿年宝藏',
      titleLine2: '来自越南深林',
      subtitle: '玉灵参 — 来自越南中部深林的天然珍宝。TA是值得信赖的玉灵参交易平台，直连三大种植基地，通过cGMP、HACCP、ISO 9001/22000认证。',
      cta: '立即探索',
      ctaSecondary: '溯源验证',
      scrollText: '向下滚动',
    },
    ...
    about: {
      ...
      title: '关于我们',
      titleHighlight: '',
      description1: 'TA是值得信赖的玉灵参交易平台，连接消费者与经过认证的种植基地及供应商，不局限于单一品牌。',
    ...
    footer: {
      ...
      contact: '联系我们',
      followUs: '关注我们',
      address: '55 Ngọc Hà Village，巴亭郡，河内，越南',
      phone: 'Zalo / WhatsApp：(84) 984 999 309',
      email: 'contact@samngoclinh-ta.vn',
  ...
  fr: {
    ...
    hero: {
      ...
      subtitle: 'TA est une place de marché transparente pour le Ginseng Ngoc Linh, connectée directement aux plus grandes régions de culture certifiées GACP-WHO du Vietnam, certifié cGMP, HACCP, ISO 9001/22000.',
      cta: 'Découvrir',
    ...
    about: {
      ...
      title: 'À Propos',
      titleHighlight: '',
      description1: 'TA est une place de marché de confiance pour le Ginseng Ngoc Linh (Panax vietnamensis), reliant les consommateurs à des régions de culture et fournisseurs vérifiés — sans se limiter à une seule marque.',
    ...
    footer: {
      ...
      address: '55 Ngoc Ha Village, Ba Dinh, Hanoï, Vietnam',
      phone: 'Zalo / WhatsApp : (84) 984 999 309',
      email: 'contact@samngoclinh-ta.vn',
  ...
  ar: {
    ...
    hero: {
      ...
      subtitle: 'جينسنغ نغوك لينه — كنز طبيعي من غابات وسط فيتنام العميقة. TA هي منصة تداول موثوقة تربط مباشرة بأكبر مناطق الزراعة المعتمدة، حاصلة على شهادات cGMP وHACCP وISO.',
      cta: 'اكتشف الآن',
    ...
    about: {
      ...
      title: 'عنا',
      titleHighlight: '',
      description1: 'TA هي منصة تداول موثوقة للجينسينغ نغوك لينه، تربط المستهلكين بمناطق زراعة وموردين معتمدين — دون الاقتصار على علامة تجارية واحدة.',
    ...
    footer: {
      ...
      contact: 'اتصل بنا',
      followUs: 'تابعنا',
      address: '55 Ngọc Hà Village، با دينه، هانوي، فيتنام',
      phone: 'Zalo / WhatsApp: (84) 984 999 309',
      email: 'contact@samngoclinh-ta.vn',
