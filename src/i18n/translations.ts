...
export const translations: Record<Language, Translation> = {
  vi: {
    ...
    heritage: {
      ...
      authorityTitle: 'Cam Kết Chất Lượng & Nguồn Gốc',
      authorityDesc: '10 năm bám núi Trà Linh, Nam Trà My cùng đồng bào Xơ Đăng. Cam kết 100% sâm chuẩn gốc, kiểm định hàm lượng Saponin rõ ràng trước khi đến tay khách hàng.', // supplier-guard-allow
  ...
  en: {
    ...
    heritage: {
      ...
      authorityTitle: 'Quality & Origin Guarantee',
      authorityDesc: '10 years on Tra Linh mountain with the Xo Dang community. Committed to 100% authentic ginseng with clear Saponin content certification before delivery.',
  ...
  zh: {
    ...
    heritage: {
      ...
      authorityTitle: '品质与原产地保证',
      authorityDesc: '10年扎根茶灵山区，与梭登族同胞共同耕耘。承诺100%正宗人参，向每位顾客提供清晰的皂苷含量检测证明。',
      saponinTitle: '52+ 种皂苷',
  ...
  fr: {
    ...
    heritage: {
      ...
      authorityTitle: 'Garantie Qualité & Origine',
      authorityDesc: '10 ans sur la montagne Tra Linh avec la communauté Xo Dang. Engagement 100% ginseng authentique, certification Saponin transparente avant livraison.',
  ...
  ar: {
    ...
    heritage: {
      ...
      authorityTitle: 'ضمان الجودة والأصل',
      authorityDesc: '10 سنوات على جبل ترا لينه مع مجتمع شو دانغ. التزام بـ 100% جنسنغ أصيل مع شهادة محتوى الصابونين الواضحة قبل التسليم.',
