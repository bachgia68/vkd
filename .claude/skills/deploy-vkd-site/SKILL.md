...
tro vao day). Netlify (`vkd-nature-storefront.netlify.app`) van con cau hinh trong repo
(`netlify.toml`) nhung KHONG con la target chinh - dung dua vao no de bao cao trang thai
site, va can hoi nguoi dung truoc khi go bo han de tranh xoa nham cau hinh con dung.
...
- Site cu/backup, khong con dung: `https://vkd-nature-storefront.netlify.app`.
